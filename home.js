...
const greetUser = (username) => {
    console.log(`Welcomd back, ${username}.`)
}
...
// console.log(canWeDeliver(85285))
...
// I started trying to get into a higher order array method but it kept giving me errors and issues so I figured that instead I would nix the idea and make the function call on the information already provided to provide a direct answer rather than needing the higher array method.
// canWeDeliverTwo(deliveryAreaZipCodes, isIn = (check) => {
//     if(check === true) {
